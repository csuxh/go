...
func main() {
	// 变量定义
	// var name, sex string = "jackxia", "female"
	var testInt int = 123
	var (
		name   = "jackxia"
		sex    = "male"
	...
	course, age := "kubernetes", 40
	fmt.Println("my age: ", age, "weight: ", weight, "name:", name, "sex:", sex, testInt)
	fmt.Println(course, age)
	...
	fmt.Printf("type of a is %T, size of a is %d", aa, unsafe.Sizeof(aa))   // a 的类型和大小
	fmt.Printf("\ntype of b is %T, size of b is %d", bb, unsafe.Sizeof(bb)) // b 的类型和大小
